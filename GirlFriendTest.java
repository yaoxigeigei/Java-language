public class GirlFriendTest {
    public static void main(String[] args) {
        ...
        //创建对象
        GirlFriend g1 = new GirlFriend("小驴子", 18, '女', "爱坤");
        GirlFriend g2 = new GirlFriend("小木木", 26, '女', "打篮球");
        GirlFriend g3 = new GirlFriend("小蛋蛋", 30, '女', "rapper");
        GirlFriend g4 = new GirlFriend("静静", 20, '女', "唱歌");
